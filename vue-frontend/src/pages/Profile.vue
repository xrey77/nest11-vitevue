    ...
    export default defineComponent({
        ...
        methods: {
            getUserprofile: async function() {
              await api.get(`api/users/getuserid/${this.userid}`, { headers: {
            ...
            // getQrcode: function() {
            //     api.get(`api/mfa/getqrcode/${this.userid}`, { headers: {
            //     Authorization: `Bearer ${this.token}`
            // }} )
            //     .then((res: any) => {
            //             if (res.data.qrcodeurl === null) {
            ...
            //             }, 1000);
            //       }, (error: any) => {
            //             this.profileMsg = error.response.data.messages.error;
            //             setTimeout(() => {
            //                 this.profileMsg = '';    
            //             }, 3000);
            //     });
            ...
            submitProfile: function() {
                ...
                api.patch(`/api/users/updateprofile/${this.userid}`, data, { headers: {
                Authorization: `Bearer ${this.token}`
                }} )
                .then((res: any) => {
                        this.profileMsg = res.data.message;
            ...
            changePassword: function() {
                ...
                api.patch(`api/users/changepassword/${this.userid}`, data, { headers: {
                Authorization: `Bearer ${this.token}`
                }} )
                .then((res: any) => {
                        this.profileMsg = res.data.message;
            ...
            changePicture: function(event: any) {
                event.preventDefault();            
                    ...
                    api.patch(`/api/users/uploadpicture/${this.userid}`, formdata, { headers: {
            ...
            enableMFA: function() {
                ...
                api.patch(`api/users/mfa/activate/${this.userid}`, data, { headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${this.token}`
                }})
                .then((res: any) => {
