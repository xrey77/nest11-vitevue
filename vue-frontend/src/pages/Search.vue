...
<div class="container-fluid mb-5">
    ...
    <div class="left-10" v-if="totalrecords > 5">
...
const getProdsearch = async (page: number, key: string) => {
    message.value = "searching...";
    await api.get(`api/products/search/${page}/${key}`)
    .then((res: any) => {
        prodsearch.value = res.data.data;
        totalrecords.value = res.data.totalItems;
        pages.value = Number(res.data.currentPage);
        totpage.value = res.data.totalPages;
